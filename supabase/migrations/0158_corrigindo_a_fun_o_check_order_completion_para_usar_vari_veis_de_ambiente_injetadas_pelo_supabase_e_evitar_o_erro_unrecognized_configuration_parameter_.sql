...
DECLARE
    ...
    -- Usando variáveis de ambiente injetadas pelo Supabase
    supabase_url text := (SELECT current_setting('supabase.url', true));
    service_role_key text := (SELECT current_setting('supabase.service_role_key', true));
