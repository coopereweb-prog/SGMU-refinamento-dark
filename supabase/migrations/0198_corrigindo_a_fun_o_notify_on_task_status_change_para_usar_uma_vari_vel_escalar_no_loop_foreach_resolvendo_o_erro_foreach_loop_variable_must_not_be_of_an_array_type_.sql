...
DECLARE
    ...
    v_admin_ids uuid[];
    v_admin_id_single uuid; -- Variável escalar para o loop FOREACH
...
BEGIN
    ...
    IF NEW.status IS DISTINCT FROM OLD.status THEN
        ...
        IF v_current_user_id IS NULL THEN
            ...
            -- v_current_user_role não é definido aqui para evitar erro de enum
        ELSE
        ...
        -- CORREÇÃO: Usando a variável escalar v_admin_id_single no loop
        FOREACH v_admin_id_single IN ARRAY v_admin_ids
        LOOP
            INSERT INTO public.notifications (user_id, title, message, link)
            VALUES (
                v_admin_id_single, -- Usando a variável escalar
