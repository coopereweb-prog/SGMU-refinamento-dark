# Documentação Técnica - Sistema de Gerenciamento de Mobiliário Urbano
...
O SGMU (Sistema de Gerenciamento de Mobiliário Urbano) é uma aplicação web completa para gerenciamento de pontos de propaganda em mobiliários urbanos, com funcionalidades de:
