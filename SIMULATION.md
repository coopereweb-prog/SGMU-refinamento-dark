...
## Overview
- Scope: End-to-end simulation of SGMU (Sistema de Gerenciamento de Mobiliário Urbano) operations across map exploration, cart, order creation, installation tasks, and reporting.
