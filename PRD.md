...
- Nome do produto: SGMU - Sistema de Gerenciamento de Mobiliário Urbano
- Stack principal: React (Vite), Next.js (módulo `sgmu-next`), Supabase, Google Maps, Radix UI, Tailwind CSS
- Objetivo: Gerenciar pontos de propaganda em mobiliários urbanos, pedidos, preços e instalação de forma eficiente, com visualização em mapa e fluxo de compra simplificado.
