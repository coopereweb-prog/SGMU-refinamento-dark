...
This agent specializes in refactoring specialist tasks for this codebase.

## Codebase Context

- **Config**: 2 symbols
- **Utils**: 7 symbols
- **Components**: 55 symbols (depends on: Utils, Controllers)
- **Controllers**: 5 symbols

## Key Patterns

Understand the patterns used in this codebase.
...
3. Focus on refactoring specialist specific tasks
